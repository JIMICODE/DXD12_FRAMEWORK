...
void GameTimer::Tick()
{
	...
	//processor goes into a power save mode or we get shuffed to 
...
void GameTimer::Stop()
{
	...
	if (!mStopped)
	{
		...
		//the Boolean falg indicating the timer is stopped
		mStopTime = currTime;
		mStopped = true;
	}
}
...
void GameTimer::Start()
{
	...
	if (mStopped)
	{
		...
		//previous time is nopt vaild, as it occurred while paused.
...
float GameTimer::TotalTime() const
{
	...
	//time, which we do not want to count. To correct this, wo can
	...
	//which we do not want to count. To correct this, we can substact
